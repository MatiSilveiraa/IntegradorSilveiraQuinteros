...
namespace Joki.Infraestructura.Migrations
{
    ...
    [Migration("20260713023243_AgregarClaseEntrenador")]
    partial class AgregarClaseEntrenador
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Joki.LogicaNegocio.Entidades.Asistencia", b =>
                {
                    ...
                    b.Property<bool>("RegistradaPorGeolocalizacion")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Joki.LogicaNegocio.Entidades.ClaseEntrenador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClaseId", "EntrenadorId")
                        .IsUnique();

                    b.ToTable("ClaseEntrenador", (string)null);
                });

            modelBuilder.Entity("Joki.LogicaNegocio.Entidades.CodigoLoginSinPassword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CodigoLoginSinPassword", (string)null);
                });
            ...
            modelBuilder.Entity("Joki.LogicaNegocio.Entidades.Recompensa", b =>
                {
                    ...
                    b.Property<bool>("OtorgaCuotaGratis")
                        .HasColumnType("bit");

                    b.Property<string>("PremioFisico")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Joki.LogicaNegocio.Entidades.SolicitudReactivacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MotivoAlumno")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.ToTable("SolicitudReactivacion", (string)null);
                });
            ...
            modelBuilder.Entity("Joki.LogicaNegocio.Entidades.Alumno", b =>
                {
                    ...
                    b.Property<bool>("BloqueadoPorDeuda")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Joki.LogicaNegocio.Entidades.SolicitudReactivacion", b =>
                {
                    ...
                    b.HasOne("Joki.LogicaNegocio.Entidades.Alumno", "Alumno")
                        .WithMany("SolicitudesReactivacion")
                        .HasForeignKey("AlumnoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Joki.LogicaNegocio.Entidades.Alumno", b =>
                {
                    ...
                    b.Navigation("SolicitudesReactivacion");
                });
