...
import type { ConflictoEntrenadorClase } from "../../types";
...
export default function ConflictoEntrenadoresModal({
  ...
  return (
    <div className="fixed inset-0 z-[99999] isolate overflow-y-auto">
      {/* Fondo oscuro */}
      <button
        type="button"
        ...
        >
            ...
            <div className="mt-6 space-y-3">
              {conflictos.map((conflicto, index) => (
                ...
                >
                  ...
                  {/* Información de la clase conflictiva */}
          ...
          <div className="mt-7 rounded-2xl border border-amber-500/20 bg-amber-500/5 p-4">
            <p className="text-sm leading-relaxed text-amber-100">
              Al continuar, la clase se guardará aunque uno o más entrenadores
              tengan otra asignación superpuesta.
            </p>
          </div>
