  ...
  return (
    <AlumnoLayout nombre={perfil?.nombre}>
      <main className="max-w-4xl mx-auto">
        ...
        "
        >
          <h2 className="text-xl font-bold mb-5">Datos Personales</h2>
        ...
        "
        >
          <h2 className="text-xl font-bold mb-5">Información Médica</h2>

          <label className="text-sm text-gray-400">Sociedad Médica</label>
        ...
        "
        >
          <h2 className="text-xl font-bold mb-5">Información de Cuenta</h2>

          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-gray-400">Racha mensual</span>

              <span>{perfil?.rachaAsistenciaMensual}</span>
            </div>
            ...
            <div className="flex justify-between">
              ...
              >
                {perfil?.bloqueadoPorInasistencias ? "Bloqueado" : "Activo"}
              </span>
            </div>
