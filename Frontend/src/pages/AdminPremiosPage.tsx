...
export default function AdminPremiosPage() {
  ...
  const entregar = async (beneficioId: number) => {
    try {
      ...
      console.error(error);
      toast.error("No fue posible marcar el premio como entregado");
    }
  };
  ...
  return (
    <div className="min-h-screen bg-[#12201b] text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-24 pb-10">
        ...
        <div className="bg-[#1a2b24] border border-[#2d463b] rounded-2xl p-5 mb-6">
        ...
        {premios.length === 0 ? (
          <div className="bg-[#1a2b24] border border-[#2d463b] rounded-2xl p-10 text-center">
          ...
          <div className="grid gap-4">
            {premios.map((premio) => (
              <div
                ...
                className="bg-[#1a2b24] border border-[#2d463b] rounded-2xl p-5 hover:border-[#4adea8]/30 transition-all"
              >
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                  ...
                  <button
                    ...
                    className="px-4 py-3 rounded-xl bg-[#4adea8] text-[#12201b] font-semibold hover:opacity-90 transition-all"
                  >
                    Marcar entregado
                  </button>
                </div>
