...
export default function AdminCuotasPage() {
  ...
  const guardarConfiguracionCuota = async () => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.mensaje ?? "No fue posible actualizar la cuota",
      );
    } finally {
  ...
  const puedeRegistrarPago = (cuota: CuotaAdmin) => {
    return (
      cuota.estado !== "PAGADA" && !cuota.bonificada && cuota.montoFinal > 0
    );
  };
        ...
        <section className="mb-8 rounded-3xl border border-[#4adea8]/20 bg-[#1a2b24] p-6">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#4adea8]/30 bg-[#4adea8]/10 px-5 py-3 font-semibold text-[#4adea8] hover:bg-[#4adea8] hover:text-[#12201b]"
            >
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              <div>
                ...
                <p className="text-gray-300 text-sm mt-3">
                  Se muestran todas las cuotas registradas para este alumno. Si
                  sigue bloqueado, revisá cuotas vencidas anteriores.
                </p>
              </div>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 px-4">
          <div className="w-full max-w-md rounded-3xl border border-[#2d463b] bg-[#1a2b24] p-7 shadow-2xl">
            ...
            <p className="mt-2 text-sm text-gray-400">
              Definí el monto base mensual que se utilizará para generar las
              próximas cuotas.
            </p>
            ...
            <div className="mt-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => setNuevoMontoCuota(e.target.value)}
              ...
              <p className="mt-2 text-xs text-gray-500">
                Valor actual: {formatearDinero(montoCuotaActual)}
              </p>
            </div>
            ...
            <div className="mt-7 flex justify-end gap-3">
              <button
                ...
                onClick={() => setModalConfiguracionCuota(false)}
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[9999] px-4">
          <div className="w-full max-w-2xl bg-[#1a2b24] border border-[#2d463b] rounded-3xl p-7 shadow-2xl">
            ...
            <p className="text-gray-400 mb-6">
              Este alumno tiene más de una cuota pendiente o vencida. Elegí cuál
              querés registrar.
            </p>
              ...
              {cuotasParaPago.map((cuota) => (
                ...
                >
                  ...
                  {cuota.vencida && cuota.estado !== "PAGADA" && (
                    <p className="text-sm text-red-400 mt-2">Cuota vencida</p>
                  )}
                </button>
              ))}
            </div>
      ...
      {cuotaPago && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[9999] px-4">
          <div className="w-full max-w-lg bg-[#1a2b24] border border-[#2d463b] rounded-3xl p-7 shadow-2xl">
            <h2 className="text-2xl font-bold mb-2">Registrar pago manual</h2>
...
function MiniResumen({ titulo, valor }: { titulo: string; valor: number }) {
  return (
